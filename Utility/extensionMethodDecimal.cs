...
namespace Utility
{
    public static class extensionMethodDecimal
    {
        public static string TryParseDecimalToWords(this decimal val, MidpointRounding midpointRounding)
        {
            return NumberToCurrencyText(val, midpointRounding);
        }
